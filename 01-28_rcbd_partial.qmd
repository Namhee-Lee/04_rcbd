...
```{r data import}
rcbd_df <-read_csv("../03_data/wheat_nk_balkh.csv")
...
options(contrasts = c("contr.sum", "contr.poly")) #categorical variable - contr sum to zero, numerical-polynominal contrast

# Model fitting
rcbd_mod <- lm (yield_kgha ~ nrate_kgha*krate_kgha, data = rcbd_dfw)
